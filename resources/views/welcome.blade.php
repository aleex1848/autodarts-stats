...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        @if($frontpageLogoMedia)
            ...
            @guest
            {{-- Login und Registrierungs-Bereiche unter dem Frontpage-Bild --}}
            <div class="mb-6 w-full lg:max-w-4xl max-w-[335px]">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    {{-- Linker Bereich: Login-Form --}}
                    <div class="bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-lg p-6 lg:p-8 flex flex-col">
                        <h2 class="text-lg font-semibold mb-4 text-[#1b1b18] dark:text-[#EDEDEC]">{{ __('Anmelden') }}</h2>
                        
                        @if ($errors->any())
                            <div class="mb-4 p-3 rounded-md bg-[#fff2f2] dark:bg-[#1D0002] border border-[#F53003] dark:border-[#F61500]">
                        ...
                        <a href="{{ route('discord.redirect') }}" class="flex items-center justify-center gap-3 w-full px-4 py-3 text-white font-medium rounded-lg transition-colors hover:opacity-90" style="background-color: #5865F2;">
                            ...
                            <span>{{ __('Mit Discord anmelden') }}</span>
                        </a>

                        {{-- Divider --}}
                        <div class="relative flex items-center">
                            <div class="flex-1 border-t border-zinc-300 dark:border-zinc-700"></div>
                            <span class="px-4 text-sm text-zinc-500 dark:text-zinc-400">{{ __('oder') }}</span>
                            <div class="flex-1 border-t border-zinc-300 dark:border-zinc-700"></div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-6">
                            ...
                            {{-- Remember Me --}}
                            <flux:checkbox name="remember" :label="__('Angemeldet bleiben')" :checked="old('remember')" />
                    ...
                    {{-- Rechter Bereich: Registrierung --}}
                    <div class="bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-lg p-6 lg:p-8 flex flex-col">
                        <h2 class="text-lg font-semibold mb-4 text-[#1b1b18] dark:text-[#EDEDEC]">
                            {{ __('Sei Dabei!') }}
                        </h2>
                        <p class="text-sm text-[#706f6c] dark:text-[#A1A09A] mb-4">
                            {{ __('Du möchtest eine Liga veranstalten und hast Genug von Spielplänen in Excel und haufenweise Spielergebnis Screenshots?') }}
                        </p>
                        <p class="text-sm text-[#706f6c] dark:text-[#A1A09A] mb-4">
                            {{ __('Du möchtest an professionell verwalteten Ligen teilnehmen und deinen Fortschritt sehen?') }}
                        </p>
                        <p class="text-sm text-[#706f6c] dark:text-[#A1A09A] mb-6">
                            {{ __('Dann registriere dich jetzt und werde Teil unserer Community! Mit unserer Plattform kannst du Ligen erstellen, verwalten und an professionell organisierten Turnieren teilnehmen. Alles automatisiert, übersichtlich und ohne manuellen Aufwand.') }}
                        </p>
                        <div class="mt-auto">
        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-es-lg rounded-ee-lg lg:rounded-ss-lg lg:rounded-ee-none">
                    <h1 class="mb-1 font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Let's get started</h1>
