    ...
    <div class="flex h-full flex-col">
        <div class="flex items-center justify-between border-b border-neutral-200 px-4 py-3 dark:border-neutral-700">
            <div>
                ...
                <p class="text-xs text-neutral-500 dark:text-neutral-400">
                    {{ __('News aus deinen Ligen und Saisons') }}
                </p>
            </div>
        </div>
        ...
        <div class="flex-1 overflow-y-auto">
            @forelse ($news as $item)
                <div wire:key="league-news-{{ $item->id }}" class="border-b border-neutral-200 px-4 py-3 hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-zinc-800/50">
