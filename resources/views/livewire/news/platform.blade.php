...
<section class="w-full space-y-6">
    <div>
        <flux:heading size="xl">{{ __('Autodarts-Liga.de News') }}</flux:heading>
        <flux:subheading>{{ __('Alle Ankündigungen und Updates') }}</flux:subheading>
    </div>
    ...
    <div class="space-y-4">
        @forelse ($news as $item)
            <div wire:key="platform-news-{{ $item->id }}" class="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
